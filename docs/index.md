---
title: "Learn Scala Free: Beginner to Master Course"
description: "Free Scala course from beginner to advanced -- hands-on lessons with runnable code and real capstone projects. Part of a 37-course free learning library."
---

# Scala Mastery Path

A structured, module-wise Scala training program that takes you from your first
`sbt` project to production-shaped, master-level engineering — with runnable
code snippets in every module and a hands-on project at the end of each level.
...
| Level 2 · Intermediate (coming soon) | Idiomatic, functional Scala | 9 topics + 1 project |
| Level 3 · Advanced (coming soon) | Concurrency, APIs, databases | 9 topics + 1 project |
...
- Every topic page has runnable code snippets — copy them into a local `.scala`
  file and run with `scala` / `sbt run`, or paste into the Scala REPL.
