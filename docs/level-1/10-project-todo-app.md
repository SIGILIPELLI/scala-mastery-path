...
7](07-case-classes.md)) — that's what makes "mark a task done without
...
8](08-pattern-matching-intro.md), and the whole `Main.scala` entry point
...
1](01-setup.md) — `args` is literally the JVM's own `String[] args`
